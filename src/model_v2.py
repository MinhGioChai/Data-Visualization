...
# ⭐ QUAN TRỌNG: Import TẤT CẢ classes từ pipeline.py
import importlib
import sys
...
try:
    ...
    print("✅ Imported classes from src/pipeline_v2.py")
...
# ... Phần còn lại của code model_v2.py giữ nguyên
...
def run_experiments(
    ...
    test_size: float = 0.2,
    random_state: int = 42,
    pipeline_path: str = "models/preprocessing_pipeline_v2.pkl"
):
    """
    ...
    for data_type in data_types:
        for model_type in models:
            ...
            try:
                ...
                # Save model
                model_path = f"models/{model_type}_{data_type}_model_v2.pkl"
...
def example_with_preprocessed_data(pipeline_path: str = 'models/preprocessing_pipeline_v2.pkl'):
    """
...
def example_single_model_preprocessed(pipeline_path: str = 'models/preprocessing_pipeline_v2.pkl'):
    """
    ...
    trainer.save_model('models/my_preprocessed_model_v2.pkl', preprocessing_pipeline=preprocessing_pipeline)
    
    return trainer


def example_load_and_predict(
    model_path: str = 'models/logistic_regression_preprocessed_model_v2.pkl',
...
if __name__ == "__main__":
    """
    USAGE: Assumes preprocessing pipeline is already saved at 'models/preprocessing_pipeline_v2.pkl'
    """
...
# Train on raw data instead
    ...
    import os
    pipeline_path = 'models/preprocessing_pipeline_v2.pkl'
