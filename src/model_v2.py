...
# Nếu pipeline_v2.py cùng thư mục
try:
    import pipeline_v2
    importlib.reload(pipeline_v2)
    from pipeline_v2 import *
    print("✅ Imported classes from pipeline_v2.py")
except ImportError:
...
def run_experiments(
    ...
    if 'preprocessed' in data_types:
        if ('xgboost' in models) or ('random_forest' in models):
            pipeline_path = r'models\tree_preprocessing_pipeline_v2.pkl'
        else:
            pipeline_path = r'models/logistic_preprocessing_pipeline_v2.pkl'
...
# Train on raw data instead
    ...
    for key, result in results_preprocessed.items():
        ...
        predictions = example_load_and_predict(
            model_path='models/xgboost_preprocessed_model_v2.pkl',
